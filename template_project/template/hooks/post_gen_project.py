...
libpaths = {
'SeismicPro': 'https://github.com/analysiscenter/SeismicPro.git',
'seismiqb': 'https://github.com/analysiscenter/seismiqb.git',
'petroflow': 'https://github.com/analysiscenter/petroflow.git',
